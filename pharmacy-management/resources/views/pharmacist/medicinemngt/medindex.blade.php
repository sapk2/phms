        ...
        <table class="table-auto w-full mt-3 border=collapse border border-gray-300">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border border-gray-300 p-2">   <img src="{{ asset('/img'.$medicine->photopath) }}" alt="{{ $medicine->name }}" class="w-16 h-16 object-cover"> <!-- Displaying image --></td>
                    <td class="border border-gray-300 p-2">{{$medicine->description}}</td>
                    <td class="border border-gray-300 p-2">{{$medicine->quantity}}</td>
                    <td class="border border-gray-300 p-2">{{$medicine->price}}RS</td>
                    <td class="border border-gray-300 p-2">{{$medicine->medicine_type}}</td>
