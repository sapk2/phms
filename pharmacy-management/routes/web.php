...
Route::middleware([ispharmacist::class])->group(function () {
    ...
    //footer
    Route::get('/footer/edit', [FooterController::class, 'edit'])->name('pharmacist.footer.edit');
    Route::put('/footer/update', [FooterController::class, 'update'])->name('pharmacist.footer.update');
